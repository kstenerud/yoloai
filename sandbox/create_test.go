...
func TestBuildContainerConfig_ValidJSON(t *testing.T) {
	agentDef := agent.GetAgent("claude")
	data, err := buildContainerConfig(agentDef, "claude --dangerously-skip-permissions", "default+host", "/Users/test/project", false, false, nil, nil, nil, nil, 0, nil, "test", "", "", false, "")
...
func TestBuildContainerConfig_StateDirName(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.agent, func(t *testing.T) {
			...
			data, err := buildContainerConfig(agentDef, "cmd", "default", "/tmp", false, false, nil, nil, nil, nil, 0, nil, "test", "", "", false, "")
			require.NoError(t, err)
			var cfg containerConfig
...
func TestBuildContainerConfig_NetworkIsolated(t *testing.T) {
	...
	data, err := buildContainerConfig(agentDef, "claude", "default", "/tmp", false, true, domains, nil, nil, nil, 0, nil, "test", "", "", false, "")
	require.NoError(t, err)
...
func TestBuildContainerConfig_AutoCommitInterval(t *testing.T) {
	...
	data, err := buildContainerConfig(agentDef, "claude", "default", "/tmp", false, false, nil, nil, nil, nil, 60, copyDirs, "test", "", "", false, "")
	require.NoError(t, err)
...
func TestBuildContainerConfig_AutoCommitIntervalZero(t *testing.T) {
	agentDef := agent.GetAgent("claude")
	data, err := buildContainerConfig(agentDef, "claude", "default", "/tmp", false, false, nil, nil, nil, nil, 0, nil, "test", "", "", false, "")
	require.NoError(t, err)
