...
func addCreateFlags(cmd *cobra.Command) {
	...
	cmd.Flags().Bool("network-isolated", false, "Allow only agent API traffic (IPv4 iptables allowlist; IPv6 unfiltered; tamper-resistant on docker only; see 'yoloai help security')")
