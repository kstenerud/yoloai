...
- Test/shell agents: no idle detection. They stay as "active" until the process exits. A full test harness is planned separately (see `docs/contributors/design/plans/README.md`).
