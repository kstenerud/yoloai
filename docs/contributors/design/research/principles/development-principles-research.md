...
`docs/contributors/standards/go.md` §What to Avoid: "Three similar lines of code are
...
4. Various intermediate designs documented in `docs/contributors/design/research/idle-detection.md`.
...
Internal source: `docs/contributors/design/research/idle-detection.md`. This file documents the
