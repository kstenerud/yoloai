...
fields than it already has. See `docs/contributors/design/plans/backend-agent-extensibility.md`
...
| `docs/contributors/architecture/README.md` | Add SSH backend to package map and command→code map |
| `docs/contributors/design/commands.md` | Add `yoloai provision` and `yoloai sync` command specs |
| `docs/contributors/design/config.md` | Add `ssh_host`, `ssh_key`, `ssh_port`, `ssh_key_check` config fields |
