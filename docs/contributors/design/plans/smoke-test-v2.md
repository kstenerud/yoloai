...
tradeoff is documented in `docs/contributors/design/security.md` (line 106). The mitigation is that
...
rules from the first sandbox (documented in `docs/contributors/backend-idiosyncrasies.md`). This
...
`docs/contributors/backend-idiosyncrasies.md` catalogs 10+ workarounds (Kata stale sockets,
