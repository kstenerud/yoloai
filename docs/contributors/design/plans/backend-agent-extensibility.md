...
**Fix C — Document the extension convention in `docs/contributors/standards/go.md`:**
...
positional construction (TBD from grep), `docs/contributors/standards/go.md`.
...
Also add a note to `docs/contributors/standards/go.md` documenting this convention so new
CLI commands get it right the first time.

**Files to change:** All files in `internal/cli/` with mistyped errors (audit
required), `docs/contributors/standards/go.md`.
