...
[`critiques-resolved.md`](critiques-resolved.md) (the critique was *applied*) and
[`critiques-deferred.md`](critiques-deferred.md) (parked with a revival trigger): items here
