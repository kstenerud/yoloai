...
**Related:** `docs/contributors/archive/investigations/ios-testing-investigation.md` (investigation and validation)
...
1. **`docs/contributors/architecture/README.md`** - Document iOS testing components
2. **`docs/contributors/design/README.md`** - Link to this design doc
