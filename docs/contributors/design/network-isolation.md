...
- **Sandbox escape via kernel/runtime exploit.** This is gVisor's and Kata's domain. Network isolation cannot help if the agent breaks out of the sandbox entirely. See [`security.md`](security.md) and `docs/contributors/design/research/security.md`.
