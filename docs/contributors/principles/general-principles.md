...
>
> **Bites when:** about to state a competitor / security / kernel fact you haven't checked · about to say what our own code does without having read that path to its end · about to dismiss one of two conflicting sources as "stale" because the other fits. · **See also:** GEN §12, GEN §13, SEC §8.
...
Three corollaries, all learned the hard way (DF94, DF96–DF98 for the first two; D120 for the third, which those did not reach):
