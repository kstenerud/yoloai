...
These principles are the tiebreakers for design questions that arise later. They cite [`docs/contributors/principles/`](../dev/principles/README.md) where applicable.
...
| **D19** | Discovered-findings file (`docs/contributors/design/unresolved-findings.md`)? | **Create empty with header.** Done 2026-05-23. | [`discovered-findings.md`](../dev/discovered-findings.md). |
