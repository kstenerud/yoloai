...
Design spec: [`docs/contributors/design/config.md`](../../design/config.md)
...
### Step 6.2 — Update `docs/contributors/architecture/README.md`
...
| `docs/contributors/architecture/README.md` | Remove all `profiles/base/` references. Update load path descriptions. |
