...
- **Pointer:** `scripts/smoke_test.py::_prompt` (current wording + iteration history), `docs/dev/backend-idiosyncrasies.md#qemu-slow-startup-exceeds-smoke-test-stall-grace-period` (existing complementary entry).
