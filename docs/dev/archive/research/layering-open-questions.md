...
**Source:** `docs/dev/OPEN_QUESTIONS.md:252`
...
**Source:** `docs/dev/OPEN_QUESTIONS.md:207–214`
...
**Source:** `docs/dev/plans/backend-agent-extensibility.md` (entire file); not in
...
**Source:** `docs/dev/plans/mcp-server.md:472–477`
...
**Source:** `docs/dev/OPEN_QUESTIONS.md:171`; also `docs/dev/plans/TODO.md:69–82`
...
**Source:** `docs/dev/OPEN_QUESTIONS.md:203`
...
**Source:** `docs/dev/OPEN_QUESTIONS.md:218`
...
**Source:** `docs/dev/OPEN_QUESTIONS.md:256`
...
**Source:** `docs/design/network-isolation.md:289–292`
...
**Source:** `docs/dev/plans/exit-codes.md:271–277`
...
**Source:** `docs/dev/plans/backend-agent-extensibility.md` Issues 8–10
...
**D7 — Pluggable `runtime.Runtime` interface** (`docs/dev/working-notes.md:145`)
...
**W11 — Runtime interface split** (`docs/dev/plans/architecture-remediation.md:276–309`)
...
**runtime-interface-spike.md** (`docs/dev/research/runtime-interface-spike.md`)
...
**capability-registry.md** (`docs/dev/plans/capability-registry.md`)
...
**development-principles.md §2 — Boundary discipline** (`docs/dev/principles/development-principles.md:72`)
...
**W12 — sandbox/ carve-up** (`docs/dev/plans/architecture-remediation.md:313–334`)
...
**soc-refactor.md — Issue 3: isolation mappings to `runtime/`** (`docs/dev/plans/soc-refactor.md:268`)
...
**backend-agent-extensibility.md Issue 6 — `InstanceConfig` grouping** (`docs/dev/plans/backend-agent-extensibility.md:309`)
...
**soc-refactor.md Issue 4 — `detectContainerBackend()` side effect** (`docs/dev/plans/soc-refactor.md:333`)
...
gate blocked partial merges; discovered-findings went to `docs/dev/discovered-findings.md`
...
> `docs/dev/discovered-findings.md`. Critical escalates; everything else parks."
...
**D7 — Backend registry evolution** (`docs/dev/working-notes.md:158`)
...
(`docs/dev/plans/soc-refactor.md:24`)
...
- `docs/design/layering.md` — architecture this scan supports
- `docs/design/layering-greenfield.md` — target package layout
- `docs/dev/plans/layering-refactor.md` — phased workstreams (W-L1–L11)
- `docs/dev/research/layering-leak-audit.md` — empirical findings (L1–L31)
- `docs/dev/OPEN_QUESTIONS.md` — primary source for open questions
- `docs/dev/plans/architecture-remediation.md` — sibling refactor (W1–W14)
- `docs/dev/plans/backend-agent-extensibility.md` — extensibility issues (10 total)
- `docs/dev/plans/soc-refactor.md` — W12 detailed design
- `docs/dev/plans/capability-registry.md` — capability-registry design (implemented)
- `docs/dev/plans/mcp-server.md` — MCP server plan
- `docs/dev/plans/exit-codes.md` — exit code taxonomy
- `docs/dev/research/runtime-interface-spike.md` — W11 spike (complete; verdict: proceed)
- `docs/dev/working-notes.md` — D-numbered decision log
- `docs/dev/principles/development-principles.md` — §2, §4, §5, §8, §9 most relevant
- `docs/dev/ARCHITECTURE.md` — code navigation guide
