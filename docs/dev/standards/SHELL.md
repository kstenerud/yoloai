...
Hook scripts and the container entrypoint trampoline are exempt — they are part of the project's runtime contract, not standalone utilities; their purpose is documented in their adjacent docs (`docs/dev/ARCHITECTURE.md`, `docs/design/bugreport.md`).
