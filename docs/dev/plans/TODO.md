...
| Tilde expansion in config | [config.md](../../design/config.md) | `~/` expanded in path-valued fields |
| Env var interpolation in config | [config.md](../../design/config.md) | `${VAR}` syntax in config values |
