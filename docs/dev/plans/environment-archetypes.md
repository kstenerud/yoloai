...
Implements the two-layer environment model from `docs/design/environments.md`.
...
**Before starting:** read `docs/design/environments.md` in full. It is the
...
- Design spec: `docs/design/environments.md`
