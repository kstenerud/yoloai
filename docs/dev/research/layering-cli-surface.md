...
**Date:** 2026-05-23 · **Scope:** Documents the *current* CLI command tree, what each command calls underneath, and where the audited leaks (L1–L31) sit on that tree. Forward-looking layout lives in [`docs/design/layering-greenfield.md`](../../design/layering-greenfield.md).
